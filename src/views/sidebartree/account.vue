  ...
  <div>    
    ...
    <el-card>
      ...
      <el-table :data="userList" border stripe>
        ...
        <el-table-column label="是否停用" prop="isFrozen" :formatter="isFrozenFormat"   v-if="colData[0].istrue"></el-table-column>
        <el-table-column label="生效日期" prop="validDate"   v-if="colData[1].istrue" ></el-table-column>
        <el-table-column label="失效日期" prop="expireDate" v-if="colData[2].istrue" ></el-table-column>        
        <el-table-column label="同用限制" prop="simualUseLimit" v-if="colData[3].istrue"></el-table-column>        
        <el-table-column label="上行带宽(kbps)" prop="inboundCar" v-if="colData[4].istrue" ></el-table-column>
        <el-table-column label="下行带宽(kbps)" prop="outboundCar" v-if="colData[5].istrue" ></el-table-column>   
        <el-table-column label="最大会话时长" prop="maxSessionTimeout" v-if="colData[6].istrue"></el-table-column>     
        <el-table-column label="记账报文间隔" prop="updateInterval" v-if="colData[7].istrue"></el-table-column>
        <el-table-column label="剩余时间（秒）" prop="secondRemain" v-if="colData[8].istrue"></el-table-column>
        <el-table-column label="剩余流量（字节）" prop="byteRemain" v-if="colData[9].istrue"></el-table-column>       
        <el-table-column label="最后修改人" prop="adminName" v-if="colData[10].istrue"></el-table-column>
        <el-table-column label="修改日期" prop="modifyDate" v-if="colData[11].istrue"></el-table-column>              
      </el-table>
      <!--分页区域-->
    ...
    <el-dialog title="添加账号" :visible.sync="addDialogVisible" width="50%" @close="addDialogClosed">
      ...
      <el-form :model="addForm" :rules="FormRules" ref="addFormRef" label-width="200px">
        ...
        <el-form-item label="密码" prop="userPassword">
          <el-input v-model="addForm.userPassword" show-password></el-input>
        </el-form-item>
        ...
        <el-form-item label="起止日期" prop="date">         
          <el-date-picker v-model="addForm.validDate" type="datetime" placeholder="选择生效日期时间" align="right"
            value-format="yyyy-MM-dd HH:mm:ss" :picker-options="pickerOptions" >
          </el-date-picker>          
          <el-date-picker v-model="addForm.expireDate" type="datetime" placeholder="选择失效日期时间" align="right"
            value-format="yyyy-MM-dd HH:mm:ss" :picker-options="pickerOptions">
          </el-date-picker>
        </el-form-item>
        <el-form-item label="同用限制" prop="simualUseLimit">
          <el-input v-model="addForm.simualUseLimit"></el-input>
        </el-form-item>
        <el-form-item label="下行带宽(kbps)" prop="inboundCar">
          <el-input v-model="addForm.inboundCar"></el-input>
        </el-form-item>
        <el-form-item label="上行带宽(kbps)" prop="outboundCar">
          <el-input v-model="addForm.outboundCar"></el-input>
        </el-form-item> 
        <el-form-item label="最大会话时长" prop="maxSessionTimeout">
          <el-input v-model="addForm.maxSessionTimeout"></el-input>
        </el-form-item>                   
        <el-form-item label="记账报文间隔" prop="updateInterval">
          <el-input v-model="addForm.updateInterval"></el-input>
        </el-form-item>
        <el-form-item label="可用时间（秒）" prop="secondRemain">
          <el-input v-model="addForm.secondRemain"></el-input>
        </el-form-item>
        <el-form-item label="可用流量（字节）" prop="byteRemain">
          <el-input v-model="addForm.byteRemain"></el-input>
        </el-form-item>        
      </el-form>
      <!--底部区域-->
    ...
    <el-dialog title="修改账号" :visible.sync="editDialogVisible" width="50%" @close="editDialogClosed">
      <el-form :model="editForm" :rules="FormRules" ref="editFormRef" label-width="200px">
        <el-form-item label="账号" prop="userName">
        ...
        <el-form-item label="密码" prop="userPassword">
          <el-input v-model="editForm.userPassword" show-password></el-input>
        </el-form-item>
        <el-form-item label="是否停用" prop="isFrozen">          
        ...
        <el-form-item label="起止日期" prop="date">            
          <el-date-picker v-model="editForm.validDate" type="datetime" placeholder="选择生效日期时间" align="right"
            value-format="yyyy-MM-dd HH:mm:ss" :picker-options="pickerOptions" @change="clearEditValidDate">
          </el-date-picker>        
          <el-date-picker v-model="editForm.expireDate" type="datetime" placeholder="选择失效日期时间" align="right"
            value-format="yyyy-MM-dd HH:mm:ss" :picker-options="pickerOptions" @change="clearEditExpireDate">
          </el-date-picker>
        </el-form-item>  
        <el-form-item label="同用限制" prop="simualUseLimit">
          <el-input v-model="editForm.simualUseLimit"></el-input>
        </el-form-item>
        <el-form-item label="上行带宽(kbps)" prop="inboundCar">
          <el-input v-model="editForm.inboundCar"></el-input>
        </el-form-item>
        <el-form-item label="下行带宽(kbps)" prop="outboundCar">
          <el-input v-model="editForm.outboundCar"></el-input>
        </el-form-item>
        <el-form-item label="最大会话时长" prop="maxSessionTimeout">
          <el-input v-model="editForm.maxSessionTimeout"></el-input>
        </el-form-item>   
        <el-form-item label="记账报文间隔" prop="updateInterval">
          <el-input v-model="editForm.updateInterval"></el-input>
        </el-form-item>
        <el-form-item label="可用时间（秒）" prop="secondRemain">
          <el-input v-model="editForm.secondRemain"></el-input>
        </el-form-item>
        <el-form-item label="可用流量（字节）" prop="byteRemain">
          <el-input v-model="editForm.byteRemain"></el-input>
        </el-form-item>      
      </el-form>
      <span slot="footer" class="dialog-footer">
